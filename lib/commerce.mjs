...
export const DEFAULT_CONTENT = {
  ...
  missionLead:'Good candy, with all profits going to Mia’s Place.',
  missionStatement:'Our commitment: donate 100% of Sunnybunch profits to Mia’s Place, our planned nonprofit for meaningful paid work and lasting opportunity.'
};
